...
// ADMIN
Route::middleware(['auth:sanctum', 'verified'])->get('Admin/Pegawai', 'App\Http\Controllers\AdminController@index')->name('indexAdmin');
...
Route::middleware(['auth:sanctum', 'verified'])->get('/Home', 'App\Http\Controllers\PenggunaController@dashboard', function () {
...
// PRINT
Route::middleware(['auth:sanctum', 'verified'])->get('/PrintLL','App\Http\Controllers\PrintController@printll')->name('PrintLL');
Route::middleware(['auth:sanctum', 'verified'])->get('/PrintSPRL','App\Http\Controllers\PrintController@printsprl')->name('PrintSPRL');
